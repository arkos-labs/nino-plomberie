              ...
              <Link key={href} to={href as "/services"} style={{ textDecoration: "none" }}>
                ...
                >
                  ...
                  <div style={{ position: "relative", zIndex: 2 }}>
                    <div style={{ display: "inline-block", background: "var(--fire-500)", color: "white", fontSize: "0.7rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.05em", padding: "4px 12px", borderRadius: "100px", marginBottom: "16px" }}>
                      URGENCE 24/7
                    </div>
                    <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.6rem", color: "var(--ink-950)", marginBottom: "12px", letterSpacing: "-0.02em" }}>{titre}</h3>
                    <p style={{ color: "var(--gray-600)", fontSize: "1.05rem", lineHeight: 1.6, margin: 0 }}>{desc}</p>
                  </div>
                </div>
              </Link>
            ))}
